...
- Fresh-install build 10 on an iPhone, launch it, and confirm the welcome screen
...
- Select build 10 or a later fully tested build, then perform one final metadata,
